...
* Added automatic per-subtask caching of costly side-input materializations for classic Java Flink DataStream execution ([#39866](https://github.com/apache/beam/issues/39866)).
